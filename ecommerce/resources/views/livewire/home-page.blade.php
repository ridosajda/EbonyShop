<div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">EBONY</span></h1>
  ...
  <div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-8 mb-12 text-center">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        CIHUYYYYYYYYYYYYYYYYYYYYYYYYYY
      </p>
    </div> 
